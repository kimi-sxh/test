 ...
 * @since   5.0.2
 */
public class LocationTextExtractionStrategyEx implements TextExtractionStrategy {
	...
	public void setLocationalResult(List<TextChunk> locationalResult) {
		this.locationalResult = locationalResult;
	}
    ...
    public  class TextChunk implements Comparable<TextChunk>{
		...
		public void setOrientationVector(Vector orientationVector) {
			this.orientationVector = orientationVector;
		}

		public int getOrientationMagnitude() {
			return orientationMagnitude;
		}

		public void setOrientationMagnitude(int orientationMagnitude) {
			this.orientationMagnitude = orientationMagnitude;
		}

		public int getDistPerpendicular() {
			return distPerpendicular;
		}

		public void setDistPerpendicular(int distPerpendicular) {
			this.distPerpendicular = distPerpendicular;
		}

		public float getDistParallelStart() {
			return distParallelStart;
		}

		public void setDistParallelStart(float distParallelStart) {
			this.distParallelStart = distParallelStart;
		}

		public float getDistParallelEnd() {
			return distParallelEnd;
		}

		public void setDistParallelEnd(float distParallelEnd) {
			this.distParallelEnd = distParallelEnd;
		}
        ...
        protected Vector orientationVector;
        /** the orientation as a scalar for quick sorting */
        protected int orientationMagnitude;
        /** perpendicular distance to the orientation unit vector (i.e. the Y position in an unrotated coordinate system)
         * we round to the nearest integer to handle the fuzziness of comparing floats */
        protected int distPerpendicular;
        /** distance of the start of the chunk parallel to the orientation unit vector (i.e. the X position in an unrotated coordinate system) */
        protected float distParallelStart;
        /** distance of the end of the chunk parallel to the orientation unit vector (i.e. the X position in an unrotated coordinate system) */
        protected float distParallelEnd;
        /** the width of a single space character in the font of the chunk */
        protected float charSpaceWidth;
